		...
		<div class="cards">
			<div v-for="member in members" :key="member.name" class="card">
				...
				<div class="card-info">
					...
					<div class="social">
						<a v-for="item in member.social" :key="item.name" :href="item.link" target="_blank" rel="noreferrer"><i :class="`fab fa-${item.name}`"></i></a>
					</div>
				</div>
			</div>
		</div>
				...
				members: [
					...
					},
					{
						...
						social: [
							{
								name: 'instagram',
								link: 'https://instagram.com/auzmarts'
							},
							{
								name: 'youtube',
								link: 'https://www.youtube.com/channel/UCl9cd4V7o1g-9I9MQOwxy0g'
							},
						]
					},
					{
					...
					},
					{
						...
						social: [
							{
								name: 'instagram',
								link: 'https://www.instagram.com/lenin_grib1870'
							},
							{
								name: 'youtube',
								link: 'https://www.youtube.com/channel/UChdA0MA3LRYDx12-qKvD6tg'
							},
						]
					}
				]
...
<style scoped>
	...
	.card-info .social a:not(:last-child) {
		margin-right: 20px;
	}
	.card-info .social i {
		font-size: 24px;
